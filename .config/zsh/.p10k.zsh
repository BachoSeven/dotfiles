# Generated by Powerlevel10k configuration wizard on 2020-04-02 at 16:10 CEST.
...
# sharp heads, round tails, 1 line, compact, many icons, fluent.
...
() {
  ...
  ######################################[ ram: free RAM ]#######################################
  # RAM color.
   typeset -g POWERLEVEL9K_RAM_FOREGROUND=202
  ...
  #function prompt_example() {
    #p10k segment -b black -f cyan -i '⭐' -t 'ciao, fra'
  #}
